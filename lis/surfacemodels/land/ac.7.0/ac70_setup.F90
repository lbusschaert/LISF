    ...
    !EOP
        ...
        do n=1, LIS_rc%nnest
            ...
            do l=1, TotalSimRuns  ! TotalSimRuns
                ...
                call set_project_input(l, 'Irrigation_Filename', trim(AC70_struc(n)%Irrigation_Filename))
                call set_project_input(l, 'Irrigation_Directory', trim(AC70_struc(n)%PathNameSimul))
