   ...
   !!! initialize run (year)
         if (InitializeRun_flag.eq.1) then !make it flex
           ...
           if (AC72_struc(n)%Temp_crit) then
               ...
               call set_project_input(int(AC72_struc(n)%irun), 'Crop_Day1', start_day_t)
           endif
           ...
           if (AC72_struc(n)%Rainfall_crit) then
               ...
               call set_project_input(int(AC72_struc(n)%irun), 'Crop_Day1', start_day_p)
           endif

           if (AC72_struc(n)%Temp_crit.and.AC72_struc(n)%Rainfall_crit) then
               call set_project_input(int(AC72_struc(n)%irun), 'Crop_Day1', max(start_day_t, start_day_t))
           endif
